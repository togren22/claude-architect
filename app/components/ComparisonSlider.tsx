...
function ClaudeContent({ index }: { index: number }) {
  if (index === 0) {
    return (
      <div className="absolute bottom-10 left-4 sm:bottom-12 sm:left-6 max-w-[85%] sm:max-w-lg w-full rounded-lg border border-neutral-700 shadow-2xl z-10 overflow-hidden" style={{ backgroundColor: "#2a2a27", maxHeight: "calc(100% - 100px)" }}>
  ...
  if (index === 0) {
    return (
      <div className="flex items-start gap-2 sm:gap-3">
        ...
        <div className="text-[10px] sm:text-[11px] leading-[1.55] text-neutral-500 font-sans space-y-1.5 sm:space-y-2 select-none pointer-events-none" style={{ opacity: 0.75 }}>
          <p>
      ...
      >
        ...
        <div className="absolute inset-0 flex">
          <div className="w-full h-full flex flex-col items-center justify-center overflow-hidden relative" style={{ backgroundColor: "#1e1e1c" }}>
            ...
            <div className="w-full h-full max-w-4xl relative flex flex-col z-10 p-4 sm:p-8">
              <div className="absolute top-3 left-3 sm:top-4 sm:left-4 px-3 py-1 rounded-full text-xs font-mono border z-10 backdrop-blur-md shadow-lg font-semibold tracking-tight" style={{ backgroundColor: "rgba(30,30,28,0.9)", borderColor: "rgba(100,140,255,0.4)", color: "#60a5fa" }}>
                Claude
              </div>

              <div className="absolute top-10 left-3 sm:top-12 sm:left-6 max-w-[60%] sm:max-w-sm">
                <div className="backdrop-blur-sm border border-neutral-600 rounded-lg rounded-tl-none px-2.5 py-1.5 sm:px-3 sm:py-2 shadow-lg" style={{ backgroundColor: "rgba(42,42,39,0.85)" }}>
              ...
              {/* Claude verdict tags */}
              <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-6 flex flex-wrap gap-1.5 z-20">
        ...
        >
          <div className="w-full h-full relative flex flex-col" style={{ backgroundColor: "#faf8f5" }}>
            ...
            {/* Prompt bubble */}
            <div className="absolute top-10 sm:top-12 right-3 sm:right-6 max-w-[60%] sm:max-w-sm z-10">
            ...
            {/* Slop text — lives in the space between prompt and tags */}
            ...
            {/* Slop verdict tags */}
            <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-6 flex flex-wrap gap-1.5 justify-end z-20">
