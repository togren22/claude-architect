      ...
      >
        ...
        <div className="absolute inset-0">
          <div className="w-full h-full flex flex-col overflow-hidden relative" style={{ backgroundColor: "#1e1e1c" }}>
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-end overflow-hidden" style={{ paddingTop: "120px", paddingBottom: "40px", paddingLeft: "12px", paddingRight: "12px" }}>
